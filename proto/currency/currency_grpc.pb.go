...
func (c *currencyClient) GetRate(ctx context.Context, in *RateRequest, opts ...grpc.CallOption) (*RateReply, error) {
...
func (UnimplementedCurrencyServer) GetRate(context.Context, *RateRequest) (*RateReply, error) {
